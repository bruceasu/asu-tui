...
import me.asu.tui.framework.core.util.ClassPathUtils;
import me.asu.tui.framework.core.util.PlaceholderUtils;
 ...
 * @author suk
 */
public class AsuCliConfigurator implements CliConfigurator
{
    ...
    private AsuCliConfigurator(String configFileName) {
    ...
    public static AsuCliConfigurator createNewInstance(String configFileName) {
        return new AsuCliConfigurator(configFileName);
    }

    public static AsuCliConfigurator createNewInstance() {
        return new AsuCliConfigurator(null);
    }
