...
import me.asu.tui.I18nUtils;
import me.asu.tui.PasswordReader;
import me.asu.tui.api.CliConsole;
import me.asu.tui.api.CliContext;

import java.io.*;

import static me.asu.tui.api.CliContext.KEY_INPUT_STREAM;
import static me.asu.tui.api.CliContext.KEY_OUTPUT_STREAM;

/**
 * @author suk
 * @since 2018/8/16
 */
public class DefaultCliConsole implements CliConsole {
    ...
    public char[] readPassword() {
        // return readByInnerReader().toCharArray();
        try {
            return PasswordReader.readPassword(I18nUtils.text("prompt.password.message")).toCharArray();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
