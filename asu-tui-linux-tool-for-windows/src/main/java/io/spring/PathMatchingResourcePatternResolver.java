...
public class PathMatchingResourcePatternResolver extends ResourcePatternResolver {
    ...
    public PathMatchingResourcePatternResolver() {
        this(new DefaultResourceResolver(), null);
    }

    public PathMatchingResourcePatternResolver(ClassLoader classLoader) {
        this(new DefaultResourceResolver(classLoader), classLoader);
    }
    ...
    protected void doRetrieveMatchingFiles(String fullPattern, File dir, Set result)
        ...
        for (int i = 0; i < dirContents.length; i++) {
            ...
            if (dirContents[i].isDirectory()
                    && (dirDepthNotFixed || countOccurrencesOf(currPath, "/") < countOccurrencesOf(fullPattern, "/"))) {
